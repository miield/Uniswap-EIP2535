...
import "swapii/liquidity/contracts/libraries/Mark.sol";
import "../interfaces/INFTSpotManager.sol";
import "./LiquidityAmounts.sol";
import "./PoolAddress.sol";
// import "./PositionKey.sol"; not used in this folder

/// @title Returns information about the token value held in a Swapii NFT
library PositionValue {
    ...
    function total(
        INFTSpotManager positionManager,
        uint256 tokenId,
    ...
    function principal(
        ...
        (, , , , , int24 tickLower, int24 tickUpper, uint128 liquidity, , , , ) = positionManager.spots(tokenId);
    ...
    function fees(INFTSpotManager positionManager, uint256 tokenId)
        internal
        view
    ...
    function _fees(INFTSpotManager positionManager, FeeParams memory feeParams)
        private
        view
        returns (uint256 amount0, uint256 amount1)
    {
            ...
            _getFeeGrowthInside(
                ISwapiiPool(
                    PoolAddress.calculatePoolAddress(
                        ...
                        PoolAddress.Pool({token0: feeParams.token0, token1: feeParams.token1, fee: feeParams.fee})
                    )
                ),
                feeParams.tickLower,
                feeParams.tickUpper
    ...
    function _getFeeGrowthInside(
        ...
        (, int24 tickCurrent, , , , , ) = pool.slit0();
        (, , uint256 lowerFeeGrowthOutside0X128, uint256 lowerFeeGrowthOutside1X128, , , , ) = pool.marks(tickLower);
        (, , uint256 upperFeeGrowthOutside0X128, uint256 upperFeeGrowthOutside1X128, , , , ) = pool.marks(tickUpper);
